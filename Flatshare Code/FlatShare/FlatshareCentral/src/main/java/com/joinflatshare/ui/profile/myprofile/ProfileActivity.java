                ...
                AmazonUploadFile.AWS_TYPE_PROFILE_IMAGE, (intent, requestCode1) -> {
                    if (requestCode1 == AmazonUploadFile.REQUEST_CODE_SUCCESS) {
                        ...
                        apiManager.updateProfile(false, user, response -> {
                            ...
                            ImageHelper.loadProfileImage(this, viewBind.imgProfile, AppConstants.loggedInUser);
                            ImageHelper.loadProfileImage(this, baseViewBinder.img_menu_profile, AppConstants.loggedInUser);
