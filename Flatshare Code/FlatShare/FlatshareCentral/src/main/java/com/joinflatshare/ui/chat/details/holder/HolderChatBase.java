            ...
            if (messageData != null) {
                ...
                if (parentMessage != null) {
                    ...
                    if (message.getSender().getUserId().equals(SendbirdChat.getCurrentUser().getUserId())) {
                        ...
                        // User
                        view_chat_reply.setBackgroundColor(ContextCompat.getColor(activity, R.color.color_text_primary));
                        txt_chat_reply_message.setTextColor(ContextCompat.getColor(activity, R.color.color_text_primary));
