...
public class FlatEditListener implements View.OnClickListener {
        ...
        if (view.getId() == R.id.btn_topbar_right) {
            ...
            AutoCompletePlaces.INSTANCE.getPlaces(activity, (intent, requestCode) -> {
                if (requestCode == REQUEST_CODE_LOCATION) {
                    if (intent != null) {
                        activity.latFlatLocation = CommonMethods.getSerializable(intent, "location", ModelLocation.class);
            ...
            AutoCompletePlaces.INSTANCE.getPlaces(activity, (intent, requestCode) -> {
                if (requestCode == REQUEST_CODE_LOCATION) {
                    ...
                    if (intent != null) {
                        activity.latSociety = CommonMethods.getSerializable(intent, "location", ModelLocation.class);
            ...
            FlatOptionActivity flatOptionActivity = new FlatOptionActivity(activity, false, (intent, requestCode) -> {
                if (requestCode == 1) {
                    MyFlatData flat = CommonMethods.getSerializable(intent, "flat", MyFlatData.class);
    ...
    private void callAPi() {
        ...
        activity.apiManager.updateFlat(true, myFlat, response -> {
            ...
            CommonMethods.makeToast("Flat profile updated");
