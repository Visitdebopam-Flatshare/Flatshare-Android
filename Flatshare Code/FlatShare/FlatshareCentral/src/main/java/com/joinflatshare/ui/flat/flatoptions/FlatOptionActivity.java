        ...
        switch (selectedViewConstant) {
            case FlatOptionConstant.VIEW_CONSTANT_AMENITY:
                if (AppData.INSTANCE.getFlatData() == null
                    ...
                    CommonMethods.makeToast( "We did not find any flat amenities options");
                else {
            ...
            case FlatOptionConstant.VIEW_CONSTANT_FURNISHING:
                if (AppData.INSTANCE.getFlatData() == null
                    ...
                    CommonMethods.makeToast( "We did not find any flat furnishing options");
                else {
            ...
            case FlatOptionConstant.VIEW_CONSTANT_ROOMSIZE:
                if (AppData.INSTANCE.getFlatData() == null
                    ...
                    CommonMethods.makeToast( "We did not find any flat size");
                else {
            ...
            case FlatOptionConstant.VIEW_CONSTANT_ROOMTYPE:
                if (AppData.INSTANCE.getFlatData() == null
                    ...
                    CommonMethods.makeToast( "We did not find any room types");
                else {
