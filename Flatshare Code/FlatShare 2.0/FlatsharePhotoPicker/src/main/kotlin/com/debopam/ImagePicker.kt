...
import com.debopam.listener.ResultListener
import com.debopam.util.DialogHelper
import java.io.File
...
open class ImagePicker {
    ...
    companion object {
         ...
         */
        @JvmStatic
        fun with(activity: ComponentActivity): Builder {
    ...
    class Builder(private val activity: ComponentActivity) {
        ...
        fun galleryOnly(): Builder {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.TIRAMISU) {
                this.imageProvider = ImageProvider.ANDROID_PICKER_13
            } else
