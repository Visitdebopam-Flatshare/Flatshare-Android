...
public class VacantBedsAdapter extends RecyclerView.Adapter<VacantBedsAdapter.ViewHolder> {
    private final RecyclerView rv;
    private final Activity activity;
    private final ArrayList<AmenitiesItem> items;
    int lastCheckedPosition = -1;

    VacantBedsAdapter(Activity activity, RecyclerView rv, ArrayList<AmenitiesItem> items) {
        this.rv = rv;
