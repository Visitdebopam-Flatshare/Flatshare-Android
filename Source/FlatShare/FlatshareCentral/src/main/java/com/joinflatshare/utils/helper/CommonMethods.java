...
public class CommonMethods {
    ...
    public static void makeToast(String message) {
        Toast.makeText(FlatShareApplication.Companion.getInstance(), message, Toast.LENGTH_SHORT).show();
    }
    ...
    public static <T extends Serializable> T getSerializable(@NotNull Intent intent, @NotNull String name, @NotNull Class<T> clazz) {
